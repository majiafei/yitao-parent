...
面对这样复杂的搜索业务和数据量，使用传统数据库搜索就显得力不从心，一般我们都会使用全文检索技术，比如之前大家接触过的Solr，solr集群太局限

不过今天，我们要讲的是另一个全文检索技术：Elasticsearch。（ES）
...
我们将安装包上传到：/home/yitao目录

![1556004711983](assets/1556004711983.png)
...
![1556004850784](assets/1556004850784.png)

进入，查看目录结构：

![1556004954618](assets/1556004954618.png)
...
![1556005069753](assets/1556005069753.png)
...
![1556005559224](assets/1556005559224.png)
...
![1556005748940](assets/1556005748940.png)
...
![1556006196878](assets/1556006196878.png)

```
[1]: max file descriptors [4096] for elasticsearch process likely too low, increase to at least [65536]
```

我们用的是yitao用户，而不是root，所以文件权限不足。
...
```
[1]: max number of threads [1024] for user [yitao] is too low, increase to at least [4096]
```
...
![1556006603555](assets/1556006603555.png)

可以看到绑定了两个端口: （记得端口需要进入防火墙）

- 9300：集群节点间通讯接口
- 9200：客户端访问接口

我们在浏览器中访问：http://192.168.3.220:9200 

![1556006948200](assets/1556006948200.png)
...
```
elasticsearch.url: "http://192.168.56.220:9200"
```
...
Lucene的IK分词器早在2012年已经没有维护了，现在我们要使用的是在其基础上维护升级的版本，并且开发为ElasticSearch的集成插件了，与Elasticsearch一起维护升级，版本也保持一致，最新版本：6.7.1

### 1.5.1.安装

上传课前资料中的zip包，解压到Elasticsearch目录的plugins目录中：

![1556007372609](assets/1556007372609.png)

使用unzip命令解压：

```
unzip elasticsearch-analysis-ik-6.7.1.zip -d ik-analyzer
```

然后重启elasticsearch：

![1556007533705](assets/1556007533705.png)
...
![1555251997171](assets/1555251997171.png)
...
![1555252065588](assets/1555252065588.png)



或者，我们可以使用*来查询所有索引库配置：

![1555252141719](assets/1555252141719.png)
...
![1555252211081](assets/1555252211081.png)

再次查看yitao：

![1555252292721](assets/1555252292721.png)

当然，我们也可以用HEAD请求，查看索引是否存在：

![1555252322017](assets/1555252322017.png)
...
{
    "title":"小米手机",
    "images":"http://image.yitao.com/12479122.jpg",
    "price":2699.00
}
```
...
<project xmlns="http://maven.apache.org/POM/4.0.0" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance"
	...
	<groupId>com.yitao.demo</groupId>
...
public void index() {
    Item item = new Item(1L, "小米手机7", " 手机",
                         "小米", 3499.00, "http://image.yitao.com/13123.jpg");
    ...
    "hits": [
      {
        ...
        "_source": {
          ...
          "brand": "小米",
          "price": 3499,
          "images": "http://image.yitao.com/13123.jpg"
        }
      }
    ]
  }
...
public void indexList() {
    ...
    list.add(new Item(2L, "坚果手机R1", " 手机", "锤子", 3699.00, "http://image.yitao.com/123.jpg"));
    list.add(new Item(3L, "华为META10", " 手机", "华为", 4499.00, "http://image.yitao.com/3.jpg"));
    // 接收对象集合，实现批量新增
...
public void indexList() {
    List<Item> list = new ArrayList<>();
    list.add(new Item(1L, "小米手机7", "手机", "小米", 3299.00, "http://image.yitao.com/13123.jpg"));
    list.add(new Item(2L, "坚果手机R1", "手机", "锤子", 3699.00, "http://image.yitao.com/13123.jpg"));
    list.add(new Item(3L, "华为META10", "手机", "华为", 4499.00, "http://image.yitao.com/13123.jpg"));
    list.add(new Item(4L, "小米Mix2S", "手机", "小米", 4299.00, "http://image.yitao.com/13123.jpg"));
    list.add(new Item(5L, "荣耀V10", "手机", "华为", 2799.00, "http://image.yitao.com/13123.jpg"));
    // 接收对象集合，实现批量新增
    itemRepository.saveAll(list);
}
```
